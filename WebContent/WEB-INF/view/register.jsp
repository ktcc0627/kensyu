...
<link rel="stylesheet" type="text/css"
	href="/AccessRecord/css/register.css">
<script type="text/javascript" src="/AccessRecord/js/register.js"></script>
...
<body>
	...
	<form name="form1" class="checkForm" id = "checkForm" action="/Confirmation" method="post">
		<div class="contact-form">
			<h1 class="section-title">新規登録画面</h1>
				<div class="raisya">
					<p>
			...
			<div class="name">
				...
				<input class="sentense" type="text" name="name" id="name" onChange="check()" value=""
			...
			<table>
				...
				<div class="name2">
					<p>
						...
						<input class="sentense" type="text" name="visitor" id="visitor" value=""
				...
				<div class="time">
					...
					<div class="name2">
						<p>
							...
							<input class="sentense" type="text" name="exit" value="" id="exit"
							placeholder="例）リブロ　太郎">
				</div>
			</div>
				<div class="button">
					<button class="button2" type="submit" formaction="./KakuninServlet"
						value="登録">登録</button>
