...
<link rel="stylesheet" type="text/css"
	href="/AccessRecord/css/kakunin.css">
...
<body>
	...
	<form method="post" action="/AccessRecord/AdminServlet" class= "form-element">
		<table>
			<tbody>
				<tr>
					<th>来社日：</th>
				...
				<tr>
					<th>退館時刻：</th>
					<td><%= request.getAttribute( "morning_afternoon_exit" ) %><%= request.getAttribute( "hour_exit" ) %>時<%= request.getAttribute( "minute_exit" ) %>分</td>
				</tr>
				<tr>
					<th>退館確認者：</th>
					<td><%= request.getAttribute( "exit" ) %></td>
				</tr>
			</tbody>
		</table>
			...
			<div class="button">
				...
				<button class="button3" type="submit" formaction="./AdminServlet" onclick="alert('登録が完了しました。')"  value="完了" >完了</button>
			</div>
	</form>
